if(CPACK_PACKAGE_FILE_NAME MATCHES ".*-src$")
    message(FATAL_ERROR "Creating source archives for SDL 3.2.8 is not supported.")
endif()

set(PROJECT_SOURCE_DIR "/Users/mars/develop/MTEngineSDL/other/lib/SDL3")
...
set(CPACK_PACKAGE_FILE_NAME "SDL3-3.2.8-${SDL_CMAKE_PLATFORM}${SDL_CPU_NAMES_WITH_DASHES}")

if(CPACK_GENERATOR STREQUAL "DragNDrop")
    set(CPACK_DMG_VOLUME_NAME "SDL3 3.2.8")
